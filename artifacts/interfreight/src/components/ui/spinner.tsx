...
function Spinner({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      role="status"
      aria-label="Loading"
      className={cn("relative inline-flex aspect-square size-5 items-center justify-center", className)}
      {...props}
    >
      ...
      <span className="relative text-[0.38em] font-extrabold tracking-[0.18em] text-white [text-shadow:0_0_8px_rgba(18,20,23,0.95),0_0_16px_rgba(18,20,23,0.75)]">IFS</span>
    </div>
  )
}
